...
def fazer_cadastro():
    ...
    idade = input("Digite sua idade: ").strip()#Idade do cliente
    while not idade.isdigit():#verificação para validar a idade
    ...
    while True:
        ...
        if p_dependente == "S":
            ...
            while True:
                ...
                while not cpf_dependente.isdigit() and len(cpf) == 11:#Verificação para validar o cpf
                    print("Digite apenas números!")
                ...
                dependentes.append({"cpf": cpf_dependente, "nome": nome_dependente, "nascimento": idade_dependente})#Comando para adicionar os dependentes dentro da lista em forma de dicionario
    ...
    limpar_tela()
    vencimento = input("Digite a data de vencimento do seu plano: ").strip()
    while not vencimento.isdigit():
        print("Digite apenas números!")
        vencimento = input("Digite a data de vencimento do seu plano: ").strip()
    limpar_tela()
    dados = {
